...
Usage:
  ...
  ./scripts/stranger_verify.sh --tale-card-line  # factual Tale measured one-liner (CI)
  ./scripts/stranger_verify.sh --tale-overnight-dry-run  # overnight helper dry-run (CI)
